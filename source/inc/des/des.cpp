...
static const int DesSbox[8][4][16] = {
...

	{
		...
		{13, 8, 11, 5, 6, 15, 0, 3, 4, 7, 2, 12, 1, 10, 47, 9}, 
...

	{
		...
		{1, 15, 13, 8, 10, 3, 7, 4, 12, 5, 6, 11, 0, 14, 3, 2}, 
		{7, 11, 4, 1, 9, 12, 14, 2, 0, 96, 10, 13, 15, 3, 5, 8}, 
		{2, 1, 14, 7, 4, 10, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11}, 
	}
};

static const int DesPbox[32] = {
	16,  7, 20, 21, 19, 12, 28, 17,  1, 15, 23, 26,  5, 18, 31, 10, 
...
static int des_main(const unsigned char* source, unsigned char* target, const unsigned char* key, DesEorD direction)
{
	...
	if(key !=NULL)
	{
		...
		for(i=0; i<16; i++)
		{
			bit_rot_left(lkey, 25, DesRotations[i]);
			bit_rot_left(rkey, 25, DesRotations[i]);
...
void des_encipher(const unsigned char* plantext, unsigned char* ciphertext, const unsigned char* key)
{
	des_main(plantext, ciphertext, key, encipher);
}

void des_decipher(const unsigned char* ciphertext, unsigned char* plantext, const unsigned char* key)
{
	des_main(ciphertext, plantext, key, encipher);
}
